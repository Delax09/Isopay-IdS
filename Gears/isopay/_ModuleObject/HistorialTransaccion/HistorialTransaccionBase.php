...
abstract class HistorialTransaccionBase extends Manager implements DboBaseObject
{
	...
	{
		$dao = null;
		$this->clave 	= "historial_transaccion_id";
		$this->tabla 	= "iso_historialtransaccion";
		$this->name 	= "HistorialTransaccion";
		$this->status	= false;
		$this->setDao(null);

		
		$this->fields = array(
					"historial_transaccion_id"		=> array("int",11,true,false,false,null), /*TIPO , LARGO , ES PK? (true), Es Serializado , Es Html,ListaBack*/
					"estado_anterior"		=> array("varchar",30,false,false,false,null), /*TIPO , LARGO , ES PK? (true), Es Serializado , Es Html,ListaBack*/
					"estado_actual"		=> array("varchar",30,false,false,false,null), /*TIPO , LARGO , ES PK? (true), Es Serializado , Es Html,ListaBack*/
