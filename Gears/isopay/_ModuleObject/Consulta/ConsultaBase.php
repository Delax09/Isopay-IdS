...
abstract class ConsultaBase extends Manager implements DboBaseObject
{
	...
	{
		$dao = null;
		$this->clave 	= "consulta_id";
		$this->tabla 	= "iso_consulta";
		$this->name 	= "Consulta";
		$this->status	= false;
		$this->setDao(null);
		...
		$this->fields = array(
					"consulta_id"		=> array("int",11,true,false,false,null), /*TIPO , LARGO , ES PK? (true), Es Serializado , Es Html,ListaBack*/
					"numero_transaccion"		=> array("varchar",255,false,false,false,null), /*TIPO , LARGO , ES PK? (true), Es Serializado , Es Html,ListaBack*/
